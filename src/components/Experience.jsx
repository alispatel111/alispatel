...
const Experience = () => {
  ...
  const experiences = [
    ...
    //   companyLogo: "/assets/company/github.png",
    //   location: "Remote",
    //   startDate: "2023",
    //   endDate: "Present",
    //   description:
    //     "Contributing to open-source MERN stack projects, fixing bugs, and implementing new features. Actively participating in code reviews and discussions to improve project quality and functionality.",
    //   skills: ["React", "Node.js", "MongoDB", "Express.js", "Git"],
    //   badgeClass: "experience-present-badge",
    //   achievements: [
    //     "Contributed to 5+ open source projects with over 10 accepted pull requests",
    //     "Fixed critical bugs that affected user experience for thousands of users",
    //     "Implemented new features that were requested by the community",
    ...
    //       icon: <FaGithub className="experience-link-icon" />,
    //     },
    //   ],
    // },
  ]
