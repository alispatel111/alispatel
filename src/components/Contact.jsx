                ...
                <div className="contact-form-group">
                  <div className="contact-input-wrapper">
                    <input
                      ...
                      required
                      className={focusedContactField.user_name || contactFormData.user_name ? "contact-focused" : ""}
                    />
                    <label
                      htmlFor="contact_user_name"
                      className={focusedContactField.user_name || contactFormData.user_name ? "contact-focused" : ""}
                    >
                      <FaUser />
                      Full Name
                ...
                <div className="contact-form-group">
                  <div className="contact-input-wrapper">
                    <input
                      ...
                      required
                      className={focusedContactField.user_email || contactFormData.user_email ? "contact-focused" : ""}
                    />
                    <label
                ...
                <div className="contact-form-group">
                  <div className="contact-input-wrapper">
                    <input
                      ...
                      required
                      className={focusedContactField.subject || contactFormData.subject ? "contact-focused" : ""}
                    />
                    <label
                ...
                <div className="contact-form-group">
                  <div className="contact-input-wrapper">
                    <textarea
                      ...
                      rows="6"
                      required
                      className={focusedContactField.message || contactFormData.message ? "contact-focused" : ""}
                    ></textarea>
                    <label
